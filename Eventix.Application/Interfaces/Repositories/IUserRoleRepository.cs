...
public interface IUserRoleRepository
{
    ...
    Task<List<string>> GetRoleNamesByUserIdAsync(Guid userId, CancellationToken cancellationToken = default);    Task AddAsync(UserRole entity, CancellationToken cancellationToken = default);
